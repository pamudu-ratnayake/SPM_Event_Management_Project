											...
											<FormGroup>
												...
												<InputGroup className="input-group-alternative">
													<InputGroupAddon addonType="prepend">
														...
														{formik.touched.date_of_the_event &&
														formik.errors.date_of_the_event ? (
															<div style={{ color: "red" }}>
																{formik.errors.date_of_the_event}
															</div>
														) : null}
									...
									<Row>
										...
										<Col md="6">
											<FormGroup>
												...
												/>
												{formik.touched.days_occurs &&
												formik.errors.days_occurs ? (
													<div style={{ color: "red" }}>
														{formik.errors.days_occurs}
													</div>
												) : null}
									...
									<Row>
										...
										<Col md="6">
											<FormGroup>
												...
												/>
												{formik.touched.org_nic && formik.errors.org_nic ? (
													<div style={{ color: "red" }}>
														{formik.errors.org_nic}
													</div>
												) : null}
											</FormGroup>
										</Col>
									...
									<Row>
										...
										<Col md="6">
											<FormGroup>
												...
												/>
												{formik.touched.cus_con_number &&
												formik.errors.cus_con_number ? (
													<div style={{ color: "red" }}>
														{formik.errors.cus_con_number}
													</div>
												) : null}
