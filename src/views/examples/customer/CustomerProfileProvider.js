...
const CustomerProfileProvider = (props) => {
	const baseStyle = {
		flex: 1,
		display: "flex",
	...
	useEffect(() => {
		API.get(`/auth-user/get-user`)
			.then((res) => {
				...
				API.get(`/customerdetails/getOneCustomer/${user?.result?._id}`).then(
					(res) => {
						console.log(res);
						setCustomer(res.data);
					}
									...
									<div className="card-profile-image">
										<a href="#pablo" onClick={(e) => e.preventDefault()}>
											<img
												...
												src={customer && customer.prof_img}
											/>
										</a>
									</div>
								</Col>
										...
										<Row>
											<Col md="6">
												<FormGroup>
													...
													/>
													{formik.touched.cus_userName &&
													formik.errors.cus_userName ? (
														<div style={{ color: "red" }}>
															{formik.errors.cus_userName}
														</div>
													) : null}
										...
										<Row>
											<Col lg="6">
												<FormGroup>
													...
													<Input
														...
														defaultValue={oneUser.firstName}
													/>
													{formik.touched.cus_FName &&
													formik.errors.cus_FName ? (
														<div style={{ color: "red" }}>
															{formik.errors.cus_FName}
														</div>
													) : null}
											...
											<Col lg="6">
												<FormGroup>
													...
													/>
													{formik.touched.cus_LName &&
													formik.errors.cus_LName ? (
														<div style={{ color: "red" }}>
															{formik.errors.cus_LName}
														</div>
													) : null}
										...
										<Row>
											<Col lg="6">
												<FormGroup>
													...
													/>
													{formik.touched.cus_contact_no &&
													formik.errors.cus_contact_no ? (
														<div style={{ color: "red" }}>
															{formik.errors.cus_contact_no}
														</div>
													) : null}
											...
											<Col md="6">
												<FormGroup>
													...
													/>
													{formik.touched.cus_nic && formik.errors.cus_nic ? (
														<div style={{ color: "red" }}>
															{formik.errors.cus_nic}
														</div>
													) : null}
												</FormGroup>
											</Col>
                    ...
                    Contact information
									...
									<div className="pl-lg-4">
										<FormGroup>
											...
											/>
											{formik.touched.cus_description &&
											formik.errors.cus_description ? (
												<div style={{ color: "red" }}>
													{formik.errors.cus_description}
												</div>
											) : null}
